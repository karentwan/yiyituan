		...
		<div class="list">
			<table cellpadding="0" cellspacing="0">
				<s:iterator value="#list" status="status" id="dynamic">
	            	...
	            	<tr class="bb">
	            	    <td>${title}
	            	       <a class="submit1" href="${pageContext.request.contextPath}/admin_deleteDynamic?id=${id}">删除</a>
	            	       <a class="submit2" href="${pageContext.request.contextPath}/admin_modifyDynamic?id=${id}">修改</a>
	            	    </td>
	                </tr>
	                </s:if>
	                <s:else>
		    ...
		    <%-- <span class="d_article">
            	<span>共3条，&nbsp;分1页，&nbsp;当前第<font>1</font>页</span>&nbsp;&nbsp;
            	<a href="#">最前页</a>
            	<a href="#">上一页</a>
            	<a href="#">下一页</a>
            	<a href="#">最后页</a>

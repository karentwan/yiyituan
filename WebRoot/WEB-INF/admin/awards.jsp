...
<body>
	...
	<form action="${pageContext.request.contextPath}/awards_edite.action" class="sui-form form-horizontal sui-validate center" method="post">
	  <div class="control-group">
	    <label for="inputEmail" class="control-label">级别</label>
	    <div class="controls">
	      <input class="input-xfat" type="text" id="userId" placeholder="rank" name="rank">
	    </div>
	  </div>
	  <div class="control-group">
	    <label for="name" class="control-label">成员</label>
	    <div class="controls">
	      <input class="input-xfat" type="text" id="money" placeholder="member"  name="member">
	    </div>
	  </div>
	  ...
	  <div class="control-group">
	    ...
	    <div class="controls">
	      <input class="input-xfat" type="text" id="money" placeholder="awardsName"  name="awardsName">
	    </div>
	  </div>
	  ...
	  <div class="control-group">
	    ...
	    <div class="controls">
	      <input type="date" name="time" id="startTime" class="picker-date" placeholder="点击选择日期">
	    </div>
	  </div>
